...
"<TR>
  <TD align='Center' height='25' style='FONT-WEIGHT: bold; FONT-SIZE: 9pt; COLOR: #ffffff; FONT-FAMILY: Verdana; BACKGROUND-COLOR:rgb(250, 168, 26)'>Dr Rana Medical Hall :: Hijama Enquiry Form</TD>
</TR>".
"<TR><TD align='left'>".
...
$mail->Subject = "Hijama Enquiry Form - Dr Rana's Medical Hall";
$mail->Body = $body;
$mail->Timeout = 3600; 
 if($mail->Send()){
